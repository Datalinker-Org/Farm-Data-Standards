...
The diagnosis of a health condition. [ICAR](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) provides a detailed document about diagnosis of health conditions.

Attribute | Data Type | Notes 
:-------- | :-------- | :----
Diagnosed By | String | Name of person.
Role Diagnosed By | Enumeration | Veterinarian, Farmer, Technician.
Affected Part | Enumeration | Body part or system affected, coded using [ICAR](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) diagnosis coding system[^IARP].
Disease Category | Enumeration | See [Animal Life](docs/ADS_AppendixB_AnimalHealth.md#Animal-Life).
Disease | String | Name of the disease.
Disease Code | Enumeration | Using [ICAR](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) diagnosis coding system[^ACVM], see [Animal Life](docs/ADS_AppendixA.md#Animal-Life).
...
Registration Number | String | [ACVM](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) registration number of product.
[SKU](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) | Integer | Stock keeping code (barcode).
Organic Approved Remedy | Boolean | True if organic approved – the default is False.
Treatment Method | Enumeration | See [Treatment Method](docs/ADS_AppendixB_AnimalHealth.md#Treatment-Method).
...
Attribute | Data Type | Notes 
:-------- | :-------- | :----
Surgery Procedure | Enumeration | See [ACVS](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) list of Surgical Procedures[^ACVS]. 
Surgery Part | Enumeration | Body part or system affected, coded using the 2nd level of the [ICAR](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) diagnosis coding system[^ACVM].
...
Affected Part | Enumeration | Body part or system affected, coded using the 2nd level of the [ICAR](docs/ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations) diagnosis coding system[^ACVM].
...
[^IARP]: [International Agreement of Recording Practices](https://www.icar.org/index.php/icar-recording-guidelines/), Guidelines approved by the General Assembly of the International Committee for Animal Recording – ICAR, June 2012.

[^ACVM]: [Search the ACVM Register](https://eatsafe.nzfsa.govt.nz/web/public/acvm-register) or view the [entire register](http://www.nzfsa.govt.nz/images/acvm/RegisteredRegistrations.csv),  Ministry for Primary Industries Online.

[^ACVS]: [Surgical Procedures](https://www.acvs.org/sites/default/files/files/Residency/Procedures/LA_Surgical_Procedures_9_13_2018.pdf), American College of Veterinary Procedures, 2012.
