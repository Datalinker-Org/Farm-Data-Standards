...
NAIT AHB TRAKA | 981-018285778231-1234567 | [NAIT](ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations)-compatible “Traka” tag issued by AHB. Traka tags[^Traka-tags] are typically used for replacements or tagging existing animals.
...
Identifier | Example | Comments
:--------- | :------ | :-------
Interbull | HOLNZLM000123456789 | [ICAR](ADS_Definitions-And-Abbreviations_Interpretation.md#Definitions-And-Abbreviations)’s Interbull[^Interbull] programme is used to compare bulls across multiple countries, and may be used to align national breeding schemes to allow comparison. The identifier contains: Breed (HOL, JEY, AYS…), Country (NZL, NDL), Sex (M), and a 12-character animal number.
